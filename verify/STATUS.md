...
<!-- nightly:begin -->
> **Automated re-verification:** ✅ 2026-08-16 04:04 UTC at commit d5a7dad — static checks, regression suite (5 files) and install→uninstall smoke all green (`verify-nightly`).
<!-- nightly:end -->
