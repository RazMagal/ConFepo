...
<!-- nightly:begin -->
> **Automated re-verification:** ✅ 2026-08-29 10:13 UTC at commit a4d6060 — static checks, regression suite (6 files) and install→uninstall smoke all green (`verify-nightly`).
<!-- nightly:end -->
